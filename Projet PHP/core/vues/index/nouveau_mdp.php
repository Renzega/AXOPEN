						...
						$.post(
							...
							function(data){
								...
								if(data == 'Success'){
									...
									error.style.display = 'none';
									error.innerHTML = '<strong>Erreur !</strong> Cette adresse email n\'existe pas.';
									error.style.display = 'block';	
									...
									$.post(
										...
										'app/processing/index/send-newpassword-email.php',
										{
											email : input_email.val(),
										},
										function(data){
											if(data == 'Success'){
												...
												success_registration.style.display = 'none';
												success_registration.innerHTML = "<strong>Félicitations !</strong> Un email de réinitialisation de mot de passe vient de vous être envoyé à l'adresse " + input_email.val() + ". Si vous n'avez pas reçu cet email, merci de réitérer votre requête.";
