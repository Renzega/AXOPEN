						...
						<div class="nano-content">
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-main">
									...
									<li>
										<a href="vip.php?p=gestion_bankrolls">
								...
								<header class="clearfix">
									<div class="row">
										<div class="col-sm-6 mt-md">
											<h2 class="h2 mt-none mb-sm text-dark text-bold">Pronostics du <?php echo date("d/m/Y"); ?></h2>
										</div>
									</div>
								</header>
								<div class="row">
									<div class="col-12">
										<div class="panel-group" id="accordionPrimary">
											...
											if($isValidSession == true)
											{
												echo $Pronostic->ShowUserPronostics($_SESSION['id']);
											}
